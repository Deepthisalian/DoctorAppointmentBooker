      ...
      /*  db = openOrCreateDatabase("AppointmentsDB", MODE_PRIVATE, null);
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                DatePickerDialog dp = new DatePickerDialog(booking2.this, new DatePickerDialog.OnDateSetListener() {
                    @Override
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TimePickerDialog tp = new TimePickerDialog(booking2.this, new TimePickerDialog.OnTimeSetListener() {
                    @Override
        ...
        b3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
               ...
               /*Cursor c=db.rawQuery("SELECT * FROM APPOINTMENT",null);
                ...
                db = new BookingHelper(booking2.this);
                ...
                if (res == -1) {
                    Toast.makeText(booking2.this, "Error in booking", Toast.LENGTH_SHORT).show();
                } else
                    Toast.makeText(booking2.this, "Booked Successfully", Toast.LENGTH_SHORT).show();
                ...
                if (e2.getText().toString().equals(date.toString())) {
                    ...
                    Intent i = new Intent(booking2.this, booking1.class);
                    i.putExtra("Message", "Task completed");
                    PendingIntent pi = PendingIntent.getActivity(booking2.this, 1, i, PendingIntent.FLAG_UPDATE_CURRENT);// it is waiting for intent i to occur
                    if (Build.VERSION.SDK_INT >= 26) {
                        ...
                        Notification.Builder nb = new Notification.Builder(booking2.this, "ch1");//2nd parameter is channel id
                        ...
                        Notification.Builder nb = new Notification.Builder(booking2.this);//2nd parameter channel id is not there
                        nb.setContentIntent(pi);
                        nb.setContentTitle("REMAINDER");
                        nb.setContentText("Your Appointment is Today");
                        nb.setAutoCancel(true); //notification disappears when it is clicked (if true)
